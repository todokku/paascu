...
class ScheduleMembershipController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.schedulemembership.index')->with('smf', $smf);
    }
    ...
    {
        return view('admin.schedulemembership.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.schedulemembership.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.schedulemembership.edit')->with('SM', $SM);
    }
