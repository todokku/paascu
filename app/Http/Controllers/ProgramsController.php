...
class ProgramsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('main.programs.index')->with('members', $members);
    ...
    {$members = Members::orderBy('school','asc')->get();
        ...
        return view('main.programs.create')->with('members', $members);
    }
    ...
    public function edit($id)
    {
        ...
        $members = Members::orderBy('school','asc')->get();
        return view('main.programs.edit')->with('program', $program)->with('members', $members);
    }
