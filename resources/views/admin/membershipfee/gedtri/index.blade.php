    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card border-light mb-3 shadow">
                <h4 class="card-header bg-white">Graduate Education Trimester Membership{{-- <a href="#"><button type="button" class="btn btn-outline-success float-right">+ Add Formula</button></a> --}}</h4>
{{--             <br> --}}
{{-- <form>
...
{{-- <span class="badge badge-success">Error</span> --}}
      ...
      <td>
<a href="{{route('gedtrienrollment.edit',['id'=>$srebmem->membership->first()->member_id])}}"><button type="button" class="btn btn-outline-primary float-left">Edit</button></a>
      </td>
    </tr>
    @endif
    @endforeach
...
messageTop: 'GRADUATE EDUCATION TRIMESTER MEMBERSHIP FEES',
}, 
],
