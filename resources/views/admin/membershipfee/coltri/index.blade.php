...
@foreach($srebmem->colmembership as $ggg)
...
{{-- <span class="badge badge-success">Error</span> --}}
      ...
      <td>
<a href="{{route('coltrienrollment.edit',['id'=>$srebmem->colmembership->first()->member_id])}}"><button type="button" class="btn btn-outline-primary float-left">Edit</button></a>
      </td>
    </tr>
    @endif
    @endforeach
