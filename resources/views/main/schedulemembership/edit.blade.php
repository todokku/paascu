    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card border-light mb-3 shadow">
                ...
                <form action="{{ route('schedulemembership.update')}}" method="POST">
...
<div class="custom-control custom-radio custom-control-inline">
  ...
  <label class="custom-control-label" for="customRadioInline2">Deactive</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="gtre" type="number" step=".01" min="0" class="form-control @error('gtre') is-invalid @enderror" name="gtre" value="{{ $SM->gtre }}" placeholder="Leave empty if last" autofocus>
