    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card border-light mb-3 shadow">
                ...
                <form action="{{ route('membershipformula.update')}}" method="POST">
...
<form action="{{ route('membershipformula.updatevariable')}}" method="POST">
<div class="form-group row">
        <input type="hidden" id="newvared_type" name="newvared_type" value = "{{$formula->formula_id}}">
                        ...
                        <div class="form-group row">
                            <label for="newvarval" class="col-md-2 col-form-label text-md-right">Default Value</label>

                            <div class="col-md-10">
                                <input id="newvarval" type="text" class="form-control @error('newvarval') is-invalid @enderror" name="newvarval" placeholder="ex. 100" required autocomplete="newvarval">
