    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card border-light mb-3 shadow">
                <h4 class="card-header bg-white">College Trimester Edit Membership<a href="{{ route('coltrimembership.index') }}"><button type="button" class="btn btn-outline-success float-right">View College Trimester Memberships</button></a></h4>
            <br>
...
<form action="{{ route('coltrienrollment.update')}}" method="POST">
    <div class="form-group row">
...
$(document).ready(function() {
   ...
   $('#acpx').val($('#acp').val());
    $("#col_tri_total_enrollment").attr('readonly', true); 
