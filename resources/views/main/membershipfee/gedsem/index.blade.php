    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card border-light mb-3 shadow">
                <h4 class="card-header bg-white">Graduate Education Semester Membership<a href="{{ route('gedenrollment.index') }}"><button type="button" class="btn btn-outline-success float-right">+ Add Graduate Education Membership</button></a></h4>
{{--             <br> --}}
{{-- <form>
...
{{-- <span class="badge badge-success">Error</span> --}}
      ...
      <td>
<a href="{{route('gedsemenrollment.edit',['id'=>$srebmem->gedmembership->first()->member_id, 'content' => $ggg->gedmembership->first()->content_id])}}"><button type="button" class="btn btn-outline-primary float-left">Edit</button></a>
      </td>
    </tr>
    @endif
    @endforeach
...
var table = $('#example').DataTable( {
        ...
        buttons: [ 
{ extend: 'print',
 text: 'Print All Graduate Education Membership Fees',
exportOptions:{ columns: [0,1,2,3,4,]},
title: 'PHILIPPINE ACCREDITING ASSOCIATION OF SCHOOLS, COLLEGES AND UNIVERSITIES (PAASCU)',
messageTop: 'GRADUATE EDUCATION SEMESTER MEMBERSHIP FEES',
}, 
],
