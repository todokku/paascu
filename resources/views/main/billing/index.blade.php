...
<a href="{{route('download.pdf',['ids'=> $etupmoc->members->id, 'idc'=> $etupmoc->id, 'mscid' => $etupmoc->content_id ])}}" ><button  type="button" class="btn btn-outline-success float-left">Save</button></a>
      ...
      <td>
@if ($etupmoc->bill == null)
    <span class="badge badge-secondary">Unavailable</span>
@elseif ($etupmoc->bill !== null)
    <span class="badge badge-success"><a style="  color: #FFF;" href="{!! asset('pdf/' . $etupmoc->bill) !!}" target="_blank">Click To View Billing!</span>
@else
